			...
			<div class="portlet-body">
				<ul class="nav nav-tabs" role="tablist" id="tablist">
					...
					foreach($aShortlists as $k=>$v) {
						...
						?>
						<li<?= $sActive;?>><a href="#shortlist_<?= $v['id'];?>" data-toggle="tab"><?= $v['name'];?></a></li>
						<?php
					}
					foreach($aSharedShortlists as $k=>$v) {
						$sActive = ($v['id'] == $iShortlist) ? ' class="active"' : '';
						?>
						<li<?= $sActive;?>><a href="#shortlist_<?= $v['id'];?>" data-toggle="tab"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span> <?= $v['name'];?></a></li>
						<?php
					}
					?>
				</ul>
				...
				foreach($aShortlists as $k=>$v) {
					...
					?>
					<div class="tab-pane<?= $sActive;?>" id="shortlist_<?= $v['id'];?>">
