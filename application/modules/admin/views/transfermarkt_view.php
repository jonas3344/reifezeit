<div class="container admin">
	...
	<div class="row well">
		...
		<table class="table">
			...
			?>	
				<thead>
					<th colspan="5"><?= $v['team_name'];?> | <a href="#"><button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Fahrer hinzufügen</button></a> <a href="#"><button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span> Team entfernen</button></a></th>
				</thead>
			<?php	
